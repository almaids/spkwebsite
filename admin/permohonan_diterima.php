...
// Get all accepted beasiswa applications data
$query = "SELECT ba.id_app, ba.tanggal_daftar, ba.status_dokumen, ba.status_keputusan, ba.total_nilai, 
          ...
          WHERE ba.status_keputusan = 'diterima'";
...
<head>
    ...
    <title>Permohonan Beasiswa Diterima - SPK Beasiswa</title>
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="section-header">
                <h1 class="section-title">Permohonan Beasiswa Diterima</h1>
            </div>
            ...
            <div class="search-container">
                <form action="" method="GET" class="search-form">
                    <div class="search-input-group">
                        ...
                        <?php if (!empty($search)): ?>
                        <a href="permohonan-diterima.php" class="clear-search-button">
            ...
            <div class="data-container">
                <?php if (empty($diterima_list)): ?>
                    <div class="alert alert-info">
                        Belum ada permohonan beasiswa yang diterima.
                    </div>
                <?php else: ?>
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php $no = 1; foreach ($diterima_list as $diterima): ?>
                                    <tr>
                                        <td><?php echo $no++; ?></td>
                                        <td><?php echo htmlspecialchars($diterima['nama']); ?></td>
                                        <td><?php echo htmlspecialchars($diterima['nim']); ?></td>
                                        <td><?php echo date('d M Y', strtotime($diterima['tanggal_daftar'])); ?></td>
                                        <td>
                                            <?php 
                                            $status_dokumen = $diterima['status_dokumen'];
                                            $badge_class = '';
                                        ...
                                        <td>
                                            <?php 
                                            if (!is_null($diterima['total_nilai'])) {
                                                echo number_format($diterima['total_nilai'], 2);
                                            } else {
                                                echo '-';
                                            }
                                            ?>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="detail_pendaftar.php?id=<?php echo $diterima['id_app']; ?>" class="btn btn-sm btn-info" title="Detail">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="dokumen.php?id=<?php echo $diterima['id_app']; ?>" class="btn btn-sm btn-secondary" title="Lihat Dokumen">
                                                    <i class="fas fa-folder-open"></i>
                                                </a>
                                                <a href="cetak_surat.php?id=<?php echo $diterima['id_app']; ?>" class="btn btn-sm btn-primary" title="Cetak Surat">
